...
$stmt = $pdo->prepare("
    SELECT pr.review_date, pr.feedback, pr.rating, e.first_name, e.last_name, d.name AS department, u.username AS reviewer
...
<?php endforeach; ?>
<?php else: ?>
<tr><td colspan="6" class="border px-4 py-2 text-gray-500">No performance reviews found.</td></tr>
<?php endif; ?>
</tbody>
</table>
</div>
